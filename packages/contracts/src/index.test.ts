...
describe("Project Studio schemas and contract", () => {
  ...
  it("exposes bounded cursor procedures for the Studio surfaces", () => {
    ...
    expect(apiContract.v2.projects.tasks.create).toBeDefined();
    expect(apiContract.v2.projects.members.add).toBeDefined();
    expect(apiContract.v2.projects.archive).toBeDefined();
    expect(apiContract.v2.projects.reviews.feedback.create).toBeDefined();
    expect(apiContract.v2.projects.assets.upload.create).toBeDefined();
