...
describe("workspace schemas and contract", () => {
  it("keeps asset and Agent dates native and exposes the typed procedure tree", () => {
    ...
    expect(apiContract.projects.assets.upload.complete).toBeDefined();
    expect(apiContract.projects.agentRuns.cancel).toBeDefined();
  });
...
describe("Project Studio schemas and contract", () => {
  ...
  it("exposes bounded cursor procedures for the Studio surfaces", () => {
    ...
    expect(apiContract.projects.tasks.create).toBeDefined();
    expect(apiContract.projects.members.add).toBeDefined();
    expect(apiContract.projects.archive).toBeDefined();
    expect(apiContract.projects.reviews.feedback.create).toBeDefined();
    expect(apiContract.projects.assets.upload.create).toBeDefined();
